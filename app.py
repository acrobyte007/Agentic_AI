...
def work_exp_generator(state: State):
    ...
    work_data = work_exp(state['resume_text'][-1].content)  # Access content of resume_text
    print("data type of work", type(work_data))
    print("this is resume text", state['resume_text'])
...
def edu_exp_generator(state: State):
    ...
    print("data type of education", type(education_data))
